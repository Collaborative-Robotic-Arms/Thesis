...
\hline
I-shape & \includegraphics[width=0.2\textwidth]{Figures/chapter4/Grasping/i_gt.png} & \includegraphics[width=0.2\textwidth]{Figures/chapter4/Grasping/i_resnet.png} & \includegraphics[width=0.2\textwidth]{Figures/chapter4/Grasping/i_swin.png} \\
\hline
L-shape & \includegraphics[width=0.2\textwidth]{Figures/chapter4/Grasping/l_gt.png} & \includegraphics[width=0.2\textwidth]{Figures/chapter4/Grasping/l_resnet.png} & \includegraphics[width=0.2\textwidth]{Figures/chapter4/Grasping/l_swin.png} \\
\hline
T-shape & \includegraphics[width=0.2\textwidth]{Figures/chapter4/Grasping/t_gt.png} & \includegraphics[width=0.2\textwidth]{Figures/chapter4/Grasping/t_resnet.png} & \includegraphics[width=0.2\textwidth]{Figures/chapter4/Grasping/t_swin.png} \\
\hline
\end{tabular}
\end{table}

\subsection{Model Selection (ResNet-UNet vs Swin Transformer)}
