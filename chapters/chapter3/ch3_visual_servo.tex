...
\begin{figure}[H]
    ...
    \includegraphics[width=0.6\textwidth]{Figures/chapter3/VISP/pinhole_model.png}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Figures/chapter3/VISP/pbvs_diagram.png}
        \caption{Position-Based (PBVS) \cite{Hutchinson1996}}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Figures/chapter3/VISP/ibvs_diagram.png}
...
\begin{figure}[H]
    ...
    \includegraphics[width=0.4\textwidth]{Figures/chapter3/VISP/homography_geometry.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{Figures/chapter3/VISP/VisualServoDiagram.png}
