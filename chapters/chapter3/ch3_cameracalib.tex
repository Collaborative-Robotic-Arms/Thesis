...
The quantitative improvement is summarized in Table~\ref{tab:final_results}. These values were extracted from the training log during model validation.

\begin{table}[H]
\centering
\caption{Quantitative Depth Accuracy Results}
\label{tab:final_results}
\renewcommand{\arraystretch}{1.2}
\begin{tabular}{|l|c|c|c|}
\hline
\textbf{Metric} & \textbf{Raw Sensor (mm)} & \textbf{Polynomial Model (mm)} & \textbf{Improvement} \\ \hline
MAE             & 0.13        & 0.13          & 0.4\%                \\ \hline
RMSE            & 0.25       & 0.17            & -                \\ \hline
Max Error       & 0.51       & 0.35             & -               \\ \hline
\end{tabular}
\end{table}
