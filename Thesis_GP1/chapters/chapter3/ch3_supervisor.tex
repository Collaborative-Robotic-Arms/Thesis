...
\begin{itemize}
    ...
    \item \textbf{Reference Frame Management:} Transform all detected poses and grasp points into the appropriate coordinate frames.
\end{itemize}
...
Services provide asynchronous request-response communication for deterministic operations that do not require real-time feedback:
...
\subsection{Transform Management and Coordinate Frames}
...
The supervisor uses transfrom functions to establish and maintain transformations:
...
\begin{enumerate}
    ...
    \item \textbf{Transform Management:} Consistent use of transformations for coordinate frame conversions.
