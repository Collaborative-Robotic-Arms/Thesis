...
MoveIt and RViz form the planning and visualization layer of the architecture. The \texttt{move\_group} node loads the robot description, semantic description, kinematics configuration, joint limits, OMPL planning configuration, and controller information. It maintains the planning scene and provides the action interface used during program validation.
