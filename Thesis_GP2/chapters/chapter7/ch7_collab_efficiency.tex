...
\begin{table}[H]
    ...
    \begin{tabular}{lcc}
        ...
        \midrule
        MTC Pipeline Computation (s) & 13.727  & 46.5\% \\
        Spatial Approach (s)        & 4.440 & 15.0\% \\
        Hardware Synchronization (s) & 8.152 & 27.6\% \\
        Safe Retraction (s)          & 3.219 & 10.9\% \\
        \midrule
        \textbf{Total Exchange Time} & \textbf{29.538} & \textbf{100\%} \\
        \bottomrule
    \end{tabular}
\end{table}
\begin{figure}[H]
