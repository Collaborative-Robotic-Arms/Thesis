...
\begin{table}[H]
    ...
    \begin{tabular}{lcc}
        ...
        \midrule
        MTC Pipeline Computation & [Data] & [Data]\% \\
        Spatial Approach         & [Data] & [Data]\% \\
        Hardware Synchronization & [Data] & [Data]\% \\
        Safe Retraction          & [Data] & [Data]\% \\
        \midrule
        \textbf{Total Exchange Time} & \textbf{[Data]} & \textbf{100\%} \\
        \bottomrule
    \end{tabular}
\end{table}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/chapter7/collab_efficiency/physical_handover.png}
