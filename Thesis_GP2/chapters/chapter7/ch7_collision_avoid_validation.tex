...
\midrule
Detection Trigger Latency & 0.075 ms & 0.114 ms & \textbf{0.089 ms} \\ 
...
Minimum Separation Distance & -- & -- & \textbf{16.00 cm} \\
\bottomrule
\end{tabular}
\end{table}
